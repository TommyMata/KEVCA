...
const SERVICIOS_OPCIONES = ['Alarmas', 'Cámaras CCTV', 'Cercas Eléctricas', 'Sensores', 'Mantenimiento', 'Otro']
          ...
          <div className="contact-info">
            ...
            <div className="contact-items reveal reveal-delay-3">
              <div className="contact-item">
                ...
                <div>
                  <strong>8896-5181 / 7019-1614</strong>
              ...
              <div className="contact-item">
                ...
                <div>
                  <strong>seckevca@gmail.com</strong>
