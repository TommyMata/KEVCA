      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <a href="#inicio" className="nav-logo" style={{ marginBottom: '4px' }}>
            ...
            <p>Su socio de confianza en soluciones de seguridad electrónica en Costa Rica. Protegemos hogares y negocios con tecnología de punta.</p>
            <div className="footer-social">
              <a href="https://www.facebook.com/kevcacr" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg>
              </a>
              <a href="mailto:seckevca@gmail.com" aria-label="Email">
          ...
          <div>
            <h4>Servicios</h4>
            <ul className="footer-links">
              {['Alarmas', 'Cámaras CCTV', 'Cercas Eléctricas', 'Sensores', 'Mantenimiento'].map((s) => (
